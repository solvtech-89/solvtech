          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-1">
                ...
                <a
                  href="#about"
                  className="relative text-gray-600 hover:text-orange-500 focus:text-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-200 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:bg-gray-50 group"
                >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-black/95 backdrop-blur-xl border-t border-orange-500/20">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a
                href="#about"
                className="block text-white hover:text-orange-300 px-3 py-2 rounded-md text-base font-medium transition-colors"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Tentang
              </a>
